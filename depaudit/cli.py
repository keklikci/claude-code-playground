...
from depaudit.parsers import parse_environment, parse_requirements
...
def _format_table(deps: Sequence[Dependency]) -> str:
    ...
    rows += [
        f"{d.name:<{name_w}}  {(d.version or '-'):<{ver_w}}  {d.source}" for d in deps
    ]
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_parse.add_argument("path", nargs="?", help="Path to a requirements.txt-style file.")
